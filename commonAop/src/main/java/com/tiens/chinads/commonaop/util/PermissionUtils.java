...
public final class PermissionUtils {
     ...
     */
    public static PermissionUtils permission(@PermissionGroup.Permissions final String... permissions) {
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(AOP.getContext());
    }
    ...
    public interface OnPermissionDeniedListener {
         ...
         * 权限申请被拒绝
         */
        void onDenied(List<String> permissionsDenied,String pageName);
    }
